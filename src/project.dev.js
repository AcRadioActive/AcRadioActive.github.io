require = function() {
  ...
  Metrics: [ function(require, module, exports) {
    ...
    "use strict";
    (true, "undefined" !== typeof cocosAnalytics) && cocosAnalytics.init({
      appID: "13798",
